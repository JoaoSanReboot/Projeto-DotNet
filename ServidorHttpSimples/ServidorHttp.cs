...
class ServidorHttp{
    ...
    private void CriarHtmlExemplo()
    {
        ...
        html.Append("<title>Pagina Html</title></head><body>");
        html.Append("<h1>Pagina Html</h1></body></html>");
    ...
    {
        string diretorio =
            "C:\\Users\\João Pedro\\Documents\\GitHub\\Projeto-DotNet\\ServidorHttpSimples\\www";
